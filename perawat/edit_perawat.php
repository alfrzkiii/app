...
include('../db.php');
$id = $_GET['id'];
$data = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM perawat WHERE id=$id"));
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="container mt-5">
    ...
    if (isset($_POST['submit'])) {
        ...
        mysqli_query($conn, "UPDATE perawat SET nama='$nama', spesialisasi='$spesialisasi', no_telp='$no_telp' WHERE id=$id");
